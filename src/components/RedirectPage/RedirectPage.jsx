  ...
  return (
    ...
    <main className={styles.container}>
        ...
        <section className={styles.main__content}>
            <p style={{ textAlign: 'start', marginBottom: '64px' }}>Если тебе интересно познакомиться с Контуром поближе, получать приглашения на полезные митапы и конференции про управление, или поговорить про работу, пожалуйста, заполни эту анкету.</p>
            <p style={{ textAlign: 'start', marginBottom: '64px' }}>
                А еще — приходи на стенд за временной татуировкой на менеджерском языке :)
            </p>
